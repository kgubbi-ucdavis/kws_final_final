...
# Input delays
set_input_delay -max 3.17 -clock [get_clocks {clk}] [get_ports {serial_line_valid}]
set_input_delay -max 3.74 -clock [get_clocks {clk}] [get_ports {serial_weight_valid}]
set_input_delay -max 4.13 -clock [get_clocks {clk}] [get_ports {start}]
set_input_delay -max 4.13 -clock [get_clocks {clk}] [get_ports {serial_line_data[*]}]
set_input_delay -min 0.3  -clock [get_clocks {clk}] [get_ports {serial_weight_data[*]}]


# Input Transition
set_input_transition -max 0.17  [get_ports {serial_line_valid}]
set_input_transition -max 0.18  [get_ports {serial_weight_valid}]
set_input_transition -max 0.84  [get_ports {start}]
set_input_transition -max 0.92  [get_ports {serial_line_data[*]}]
set_input_transition -max 0.97  [get_ports {serial_weight_data[*]}]

# Output delays
set_output_delay -max 0.7  -clock [get_clocks {clk}] [get_ports {done}]
set_output_delay -max 0.7  -clock [get_clocks {clk}] [get_ports {serial_result_valid}]
set_output_delay -max 0.7 -clock [get_clocks {clk}] [get_ports {serial_result[*]}]
